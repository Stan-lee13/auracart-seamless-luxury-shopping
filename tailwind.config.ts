...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // AuraCart Brand Colors
        "stained-glass": "hsl(var(--stained-glass))",
        "leather-saddle": "hsl(var(--leather-saddle))",
        rosepine: "hsl(var(--rosepine))",
        "cinnamon-slate": "hsl(var(--cinnamon-slate))",
        "sea-salt": "hsl(var(--sea-salt))",
        "glacier-white": "hsl(var(--glacier-white))",
